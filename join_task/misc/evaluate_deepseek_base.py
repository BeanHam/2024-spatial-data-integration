...
def evaluate_deepseek(data, client, model):    
    model_outputs = []            
...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='deepseek')
    parser.add_argument('--dataset', type=str, default='beanham/spatial_join_dataset')
    parser.add_argument('--key', type=str, default='deepseekkey')
    ...
    for config in configs:
        ...
        outputs = evaluate_deepseek(test, client, args.model_repo)
