...
if __name__ == '__main__':
    ...
    args.output_dir = f"outputs_{args.model_id}/{args.metric_name}/{args.metric_value}/{args.proportion}" 
    args.save_dir = args.output_dir+'/final_model/'
    args.project_name = "spatial-join"
    args.wandb_name = f"unsloth_{args.model_id}_{args.metric_name}_{args.metric_value}_{args.proportion}"
    args.hf_name = f"spatial_join_{args.model_id}_{args.metric_name}_{args.metric_value}_{args.proportion}"
