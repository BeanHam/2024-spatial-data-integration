...
## no heuristics
## -------------------
instruction_no_heur="""You are a helpful geospatial analysis assistant. I will provide you with a pair of (sidewalk, road) geometries in GeoJSON format, along with a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road. If it does, return 1. Otherwise, return 0. No explaination is needed."""
...
## angle
instruction_heur_hint_angle="""You are a helpful geospatial analysis assistant. I will provide you with a pair of (sidewalk, road) geometries in GeoJSON format, along with a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road by evaluating the following condition:
...
## distance
instruction_heur_hint_distance="""You are a helpful geospatial analysis assistant. I will provide you with a pair of (sidewalk, road) geometries in GeoJSON format, along with a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road by evaluating the following condition:
...
## combination
instruction_heur_hint_comb="""You are a helpful geospatial analysis assistant. I will provide you with a pair of (sidewalk, road) geometries in GeoJSON format, along with a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road by evaluating the following conditions:
...
I will also provide a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road by evaluating the following condition:
...
I will also provide a satellite image that visualizes their orientations. In the image, the blue line represents the road, and the red line represents the sidewalk. Your task is to determine whether the sidewalk runs alongside the road by evaluating the following conditions:
